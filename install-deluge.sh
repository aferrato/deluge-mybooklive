...
echo -e "$(tput bold)$(tput setaf 6)Creating the new sources.list for Deluge$(tput sgr0)"
...
echo -e "$(tput bold)$(tput setaf 6)Creating the file /etc/apt/preferences$(tput sgr0)"
